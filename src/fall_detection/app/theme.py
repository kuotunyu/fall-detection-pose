...
@media (max-width: 650px) { .gradio-container { padding:10px !important; }.fd-nav { padding:0 16px; }.fd-nav>div:last-child { display:none; }.fd-brand { font-size:18px; }.fd-header { padding:22px 17px 17px; gap:16px; }.fd-header h1 { font-size:32px; }.fd-header>div:last-child>p { font-size:17px; }.fd-header li { font-size:13px; }.fd-evidence { grid-template-columns:1fr; }.fd-metric { min-height:58px; border-right:0; border-bottom:1px solid var(--fd-line); }.fd-metric:last-child { border-bottom:0; }.fd-workspace { display:flex !important; flex-direction:column !important; }.fd-video, .fd-result-html { padding:10px !important; }.fd-event { display:block; }.fd-event-grid { grid-template-columns:1fr 1fr; }.fd-event-grid>div:nth-child(even) { border-right:0; }.fd-event-grid dd { font-size:20px; }.fd-rules code { font-size:16px; }.fd-rules li { grid-template-columns:minmax(0,1fr) 70px; }.fd-no-event dl { grid-template-columns:1fr; }.fd-no-event dl>div { border-right:0; border-bottom:1px solid var(--fd-line); }.fd-no-event dl>div:last-child { border-bottom:0; }.fd-actions button, .fd-output-actions button { min-height:48px !important; width:100%; }.fd-progress { padding:16px; } }
"""
