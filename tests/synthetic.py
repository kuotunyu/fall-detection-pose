...
SIT = np.array(
    [
        ...
        (0.38, -1.24),
        (0.08, -0.97),
        (0.44, -0.97),  # 肩中點 (0.26,-0.97) → 軀幹傾角 ≈ 15°
        (0.20, -0.50),
        (0.40, -0.50),
        (0.25, -0.10),
        (0.45, -0.10),
...
LIE = np.array(
    [
        ...
        (0.90, 0.08),
        (1.80, 0.02),
        (1.80, 0.08),  # 踝中點 y=0.05 → h_hip ≈ 0.05
    ]
)
...
def drop_keypoints(
    df: pd.DataFrame, t0_s: float, t1_s: float, sentinel: float = 0.0
) -> pd.DataFrame:
